...
static int curRenderer = REND_SOFT;
...
void swapBuffers()
{
	if (NativeLibClass == 0)
	{
		NativeLibClass = env_->FindClass("com/beloko/opengames/bstone/NativeLib");
...
void initControls(int width, int height,const char * graphics_path,const char *settings_file)
{
	...
	if (!controlsCreated)
	{
		...
		tcMenuMain->addControl(new touchcontrols::Button("weapon1",touchcontrols::RectF(1,8,3,10),"key_1",SDL_SCANCODE_1));
		tcMenuMain->addControl(new touchcontrols::Button("weapon2",touchcontrols::RectF(3,8,5,10),"key_2",SDL_SCANCODE_2));
		tcMenuMain->addControl(new touchcontrols::Button("weapon3",touchcontrols::RectF(5,8,7,10),"key_3",SDL_SCANCODE_3));
		tcMenuMain->addControl(new touchcontrols::Button("weapon4",touchcontrols::RectF(7,8,9,10),"key_4",SDL_SCANCODE_4));
		tcMenuMain->addControl(new touchcontrols::Button("weapon5",touchcontrols::RectF(9,8,11,10),"key_5",SDL_SCANCODE_5));

		tcMenuMain->addControl(new touchcontrols::Button("weapon6",touchcontrols::RectF(15,8,17,10),"key_6",SDL_SCANCODE_6));
		tcMenuMain->addControl(new touchcontrols::Button("weapon7",touchcontrols::RectF(17,8,19,10),"key_7",SDL_SCANCODE_7));
		tcMenuMain->addControl(new touchcontrols::Button("weapon8",touchcontrols::RectF(19,8,21,10),"key_8",SDL_SCANCODE_8));
		tcMenuMain->addControl(new touchcontrols::Button("weapon9",touchcontrols::RectF(21,8,23,10),"key_9",SDL_SCANCODE_9));
		tcMenuMain->addControl(new touchcontrols::Button("weapon0",touchcontrols::RectF(23,8,25,10),"key_0",SDL_SCANCODE_0));
