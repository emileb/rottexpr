...
LOCAL_CFLAGS = -DROTTEXPR -DSHAREWARE=0 -DSUPERROTT=0 -DSITELICENSE=0 -DUSE_SDL=1 -DPLATFORM_UNIX=1 -D_GNU_SOURCE -fsigned-char -D__MOBILE__ -DENGINE_NAME=\"rottexpr\" -Wno-error=format-security
